...
\begin{frame}{Preselection}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=0.65\textwidth,trim=0 1em 0 0,clip]{../../../plots/pid_plot.pdf}
  \begin{itemize}
...
\begin{frame}{Outlook}
  \begin{itemize}
    \item Analysis of $B\to D \mu^+\mu^-$ has been started
    ...
    \begin{itemize}
      ...
      \item Investigate $B^+ \to D^{+*}\mu\mu$,\ $B^+ \to D_s^{+}\mu\mu$,\ $B_c^+\to D_s^+\mu\mu$
